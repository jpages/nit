...
redef class MOStats
	...
	do
		...
		table3 += "\\hline\n"
		table3 += "total improved & {pstats.matrix[27][0] + pstats.matrix[29][0]} & {pstats.matrix[27][1] + pstats.matrix[29][1]} & {pstats.matrix[27][2] + pstats.matrix[29][2]} & {total_table3} & {total_table3*100/improvables[4].to_i}\\\\\n"
