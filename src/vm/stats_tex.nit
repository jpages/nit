...
redef class MOStats
	...
	do
		...
		improvable_methods = vm.pstats.matrix[28][0] + other_methods
		improvable_attributes = vm.pstats.matrix[28][1] + other_attributes
		improvable_casts = vm.pstats.matrix[28][2] + other_casts
	...
	do
		...
		var table3 = "CallSite & {vm.pstats.matrix[27][0]} & {vm.pstats.matrix[27][1]} & {vm.pstats.matrix[27][2]}  & {total_callsites_improved*100/total_callsites_improvable}\\\\\n"
		table3 += "ReadSite & {0} & {0} & {0} & {0}\\\\\n"
		table3 += "NewSite & {vm.pstats.matrix[24][0]} & {vm.pstats.matrix[24][1]} & {vm.pstats.matrix[24][2]} & {total_new_improved*100/total_new_improvable}\\\\\n"
		table3 += "other & {vm.pstats.matrix[29][0]} & {vm.pstats.matrix[29][1]} & {vm.pstats.matrix[29][2]} & {total_other_improved*100/total_other_improvable}\\\\\n"
